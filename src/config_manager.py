...
class ConfigManager:
    ...
    def create_config_from_env(self) -> Config:
        ...
        if not openai_api_key:
            ...
            if saved_ai_config:
                openai_api_key = saved_ai_config.get("api_key")
                openai_base_url = openai_base_url or saved_ai_config.get("base_url", "https://api.openai.com/v1")
                model_name = model_name or saved_ai_config.get("model", "gpt-3.5-turbo")
...
"""
    ...
    def create_config_interactive(self, cookie: str, ai_config: Dict[str, str]) -> Config:
        ...
        config = Config(
            ...
            openai_base_url=ai_config.get("base_url", "https://api.openai.com/v1"),
